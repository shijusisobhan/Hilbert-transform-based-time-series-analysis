We provide here the description of the each Matlab files that used in our work

Programs are developed in Matlab R2013a  

Machine specification:2GHz Intel core i7 4510u CPU
...
2. Period_det_Tyson1999.m

This is the program to determine the period of the tyson et al model using Hilbert transform.
using this program we can generate Fig 3.

**********************************************************************************************

3. Tyson_stochastic_period.m
...
**********************************************************************************
6. PRC_Drosophila_goldbeter1999.m
